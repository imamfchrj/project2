...
<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu my-5">
        ...
        @if (auth()->user()->hasRole(\App\Models\Role::ADMIN) || auth()->user()->roles[0]->name == "Reviewer")
            <li class="{{ ($currentAdminMenu == 'settings') ? $activeClass : '' }}"><a class="nav-link" href="{{ url('admin/users_login_his')}}"><i class="fas fa-cogs"></i> <span>User Login History</span></a></li>
        @endif
    </ul>
</aside>
