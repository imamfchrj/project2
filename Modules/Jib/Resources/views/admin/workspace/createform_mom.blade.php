                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <textarea name="catatan" class="form-control" style="height: 70px;">{{ !empty($mom->catatan) ? $mom->catatan : '' }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    {!! Form::select('anggaran', $anggaran, !empty($mom->anggaran) ? $mom->anggaran : old('anggaran'), ['class' => 'form-control', 'placeholder' => '-- Select --']) !!}
                                </div>
                            </div>
                        </div>
